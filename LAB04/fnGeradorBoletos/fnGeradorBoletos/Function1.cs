...
public GeradorCodigoBarras (ILogger<GeradorCodigoBarras> logger)
    ...
    public async Task<IActionResult> Run([HttpTrigger(AuthorizationLevel.Function, "post")] HttpRequest req)
    {
        try
        {
            ...
            {
                return new BadRequestObjectResult("Os campos valor e vencimento são obrigatórios");
            }
            ...
            {
                return new BadRequestObjectResult("Data de Vencimento Inválido");
            }
            ...
            //Prencimento do barCode para ter 44 caracteres
            barcodeData = basecode.Length < 44 ? valor = basecode.PadRight(44, '0') : basecode.Substring(0, 44);
